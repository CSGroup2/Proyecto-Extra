...
namespace Model {
    public class Conductor : Persona {
        ...
        public Conductor (int id_conductor, DateTime fecha_contrato, string diponibilidad, string estado, int id_persona, string cedula, string nombre_1, string nombre_2, string apellido_1, string apellido_2, string sexo, DateTime fecha_nac, string telefono) : base (id_persona, cedula, nombre_1, nombre_2, apellido_1, apellido_2, sexo, fecha_nac, telefono) {
